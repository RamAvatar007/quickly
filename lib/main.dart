...
import 'screens/auth_screens/verify_and_reset_password_screen/verify_and_reset_password_screen/verify_and_reset_password_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const VerifyAndResetPasswordScreen(),
    );
  }
}
